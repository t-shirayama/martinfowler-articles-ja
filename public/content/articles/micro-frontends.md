...
Charles Korn、Andy Marks、Willem Van Ketwichによる徹底したレビューと詳細なフィードバックに、心から感謝する。

Thoughtworks内部メーリングリストで意見を寄せてくれたBill Codding、Michael Strasser、Shirish Padalkarにも感謝する。

Martin Fowlerにも、フィードバックと、この記事に彼のWebサイトという場所を与えてくれたことへ感謝する。

そして最後に、Evan BottcherとLiauw Fendyの励ましと支援に感謝する。

### 重要な改訂

- 2019年6月19日: 欠点に関する最終回を公開。
- 2019年6月17日: 例を含む回を公開。
- 2019年6月13日: スタイリングからテストまでのセクションを含む回を公開。
- 2019年6月11日: 統合アプローチに関する回を公開。
- 2019年6月10日: 利点を扱う最初の回を公開。
